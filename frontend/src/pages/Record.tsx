...
export default function Record() {
  const { startRecording, stopRecording, isRecording, recordStatus, summary, language } = useStore();
        ...
        <div className="rounded-3xl border border-slate-200 bg-white/80 p-8 shadow-lg flex-1 flex flex-col justify-center items-center">
          <div className="w-full max-w-sm">
            <div className="flex items-center justify-between mb-8">
              <p className="text-lg font-bold text-slate-800">{isHindi ? "ध्वनि प्रविष्टि" : "Voice Entry"}</p>
            ...
            >
              {isRecording ? (isHindi ? "रिकॉर्डिंग..." : "Recording...") : (isHindi ? "रिकॉर्डिंग शुरू करें" : "Start Recording")}
            </button>
