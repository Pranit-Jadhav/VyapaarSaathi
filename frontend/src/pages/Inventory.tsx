...
export default function Inventory() {
  ...
  return (
    <div className="flex flex-col gap-6 flex-1">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-lg">
        <div className="flex flex-wrap items-start justify-between gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={openNew}
              className="rounded-full bg-teal-500 px-5 py-2 text-sm font-semibold text-white shadow hover:bg-teal-600 transition"
            >
      ...
      {/* ── Add / Edit Form ─────────────────────────────────────────────────── */}
      {showForm && (
        <div className="rounded-3xl border border-teal-200 bg-teal-50/80 p-6 shadow">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                className="rounded-xl border border-slate-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-teal-300 disabled:bg-slate-100"
              />
            </label>
            <label className="flex flex-col gap-1">
              ...
              <input
                ...
                className="rounded-xl border border-slate-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-teal-300"
              />
            </label>
            <label className="flex flex-col gap-1">
              ...
              <select
                ...
                className="rounded-xl border border-slate-200 px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-teal-300 bg-white"
              >
          ...
          <div className="flex gap-3 mt-5">
            <button
              ...
              className="rounded-full bg-teal-500 px-6 py-2 text-sm font-semibold text-white hover:bg-teal-600 disabled:opacity-50 transition"
            >
      ...
      {catalogItems.length === 0 && !showForm && (
        <div className="rounded-3xl border border-slate-200 bg-white/80 p-12 shadow text-center">
          ...
          <button
            onClick={openNew}
            className="mt-5 rounded-full bg-teal-500 px-6 py-2.5 text-sm font-bold text-white hover:bg-teal-600 transition"
          >
              ...
              >
                ...
                <div className="flex gap-2 pt-1">
                  <button
                    ...
                    className="flex-1 rounded-xl border border-teal-200 bg-teal-50 py-1.5 text-xs font-semibold text-teal-700 hover:bg-teal-100 transition"
                  >
